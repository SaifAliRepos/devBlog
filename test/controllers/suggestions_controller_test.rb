...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference("Suggestion.count") do
      post suggestions_url, params: { suggestion: { find: @suggestion.find, replace: @suggestion.replace } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { find: @suggestion.find, replace: @suggestion.replace } }
